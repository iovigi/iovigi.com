...
(function() {
    // Wait for SmartMenus plugin to be available before executing
    function initBootstrapAddon() {
        if (typeof window !== 'undefined' && window.jQuery && window.jQuery.fn && window.jQuery.fn.smartmenus) {
            // Execute the original bootstrap addon code
            ...
            setTimeout(initBootstrapAddon, 50);
        }
    }
    ...
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', function() {
            setTimeout(initBootstrapAddon, 100);
        });
    } else {
        setTimeout(initBootstrapAddon, 100);
    }
